...
g1 = pygame.FULLSCREEN
g = pygame.display.set_mode((0,0), pygame.FULLSCREEN)
g.blit(sup,[540,380]) 
print(g1)
while True:
#========cores=======
...
#========i======
         i = ("oitava: " + str(oitava))  
#========blits1=====  
         g.blit(font_txt.render("q = do" ,1,preto),[550,x])
         g.blit(font_txt.render("w = do#" ,1,preto),[550,x+40])
         g.blit(font_txt.render("e = re" ,1 ,preto),[550,x+80])
         g.blit(font_txt.render("r = re#" ,1,preto),[550,x+120])
         g.blit(font_txt.render("t = mi" ,1 ,preto),[550,x+160])
         g.blit(font_txt.render("y = fa" ,1,preto),[550,x+200])
         g.blit(font_txt.render("u =fa#" ,1 ,preto),[550,x+240])
#========blits2=====
         g.blit(font_txt.render("a = sol" ,1 ,preto),[1125,x1])
         g.blit(font_txt.render("s = sol#" ,1 ,preto),[1125,x1+40])
         g.blit(font_txt.render("d = la" ,1 ,preto),[1125,x1+80])
         g.blit(font_txt.render("f = la#" ,1 ,preto),[1125,x1+120])
         g.blit(font_txt.render("g = si" ,1 ,preto),[1125,x1+160])
         g.blit(font_txt.render("s = do_a" ,1 ,preto),[1125,x1+200]) 
         g.blit(font_txt.render(i,1,preto),[845,660])
#========blits2=====         
         ...
         for event in pygame.event.get():
            if (event.type == KEYDOWN and gamb == True):
                ...
                if(event.key==pygame.K_o and oitava > 2 ):
                   g.blit(font_txt.render(i,1,branco),[845,660])
                   oitava= oitava - 1
